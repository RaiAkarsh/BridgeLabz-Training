    ...
    static void manageContacts(ContactService contactService) {
        ...
        while (manage) {
            ...
            switch (choice) {
                ...
                case 5:
                    contactService.sortContactsByCity();
                    break;

                case 6:
                    contactService.sortContactsByState();
                    break;

                case 7:
                    contactService.sortContactsByZip();
                    break;

                case 8:
                    contactService.writeContactsToFile("AddressBook.txt");
                    break;
                
                case 9:
                    contactService.readContactsFromFile("AddressBook.txt");
                    break;
